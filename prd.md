...
**Version:** 3.0 (Manual Verification & Streamlined Form)
...
**2. Distance Formula (For** difficulty **and** hands\_on**)**

Mismatch in *either* direction penalizes the score.

$$\text{raw\_score} = 5 - \vert{}\text{student\_value} - \text{course\_value}\vert{}$$
